...
import { addQuestions, deleteQuestion,BanAccount, updateAnswer, updateQuestion, viewQuestions, viewUsers } from "./admin.service.js";
...
router.delete("{/:userId}/ban-account", asyncHandler(BanAccount));
